 ...
 */
final class Version20230123114523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F69E9AA99 FOREIGN KEY (gpost_id) REFERENCES post (id)');
